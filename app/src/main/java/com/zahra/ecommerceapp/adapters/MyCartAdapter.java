...
import com.zahra.ecommerceapp.models.MyCartModel;
...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.totalPrice.setText(String.valueOf(list.get(position).getTotalQuantity()));
        holder.totalQuantity.setText(list.get(position).getTotalPrice());
